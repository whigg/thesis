...
def heatmap():
	...
	for i, start in enumerate(start_list):
		...
		#helmert_90_data = pd.read_csv(hermert_file_name_90)
		#csv_Helmert_30の当該月のcsvを読み込む
		hermert_file_name_30 = "../data/csv_Helmert_both_30/Helmert_both_30_" + str(start)[:6] + ".csv"
		helmert_30_data = pd.read_csv(hermert_file_name_30)
		#木村のcsvの読み込み(90)
		#coeff_file_name_90 = "../data/csv_A_90/ssc_amsr_ads" + str(start)[2:6] + "_90_fin.csv"
		#coeff_90_data = calc_data.get_1month_coeff_data(coeff_file_name_90)
		...
		helmert_30_data["cross_ic0_sit"] = helmert_30_data["ic0_30"] * helmert_30_data["sit_30"] /100
		helmert_30_data["ocean_speed"] = np.sqrt(helmert_30_data["ocean_u"]**2 + helmert_30_data["ocean_v"]**2)

		cr = ['A', 'theta', 'R2', 'epsilon2', 'ic0_30', 'sit_30', 'cross_ic0_sit', 'ocean_speed']
		cr_matrix = helmert_30_data.loc[helmert_30_data.area_label==7, cr].corr()
